...
<body class="min-h-screen bg-white dark:bg-zinc-800">
    <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navbar class="-mb-px max-lg:hidden">
            ...
            <flux:navbar.item icon="shopping-bag" :href="route('products.index')"
                :current="request()->routeIs('products.*')" wire:navigate>
                Produtos
            </flux:navbar.item>
            <flux:navbar.item icon="calendar" :href="route('fairs.index')" :current="request()->routeIs('fairs.*')"
                wire:navigate>
                Feirinhas
            </flux:navbar.item>
            <flux:navbar.item icon="credit-card" :href="route('pos')" :current="request()->routeIs('pos')"
                wire:navigate>
                Caixa
            </flux:navbar.item>
            <flux:navbar.item icon="users" :href="route('customers.index')"
    ...
    <flux:sidebar stashable sticky
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group :heading="__('Platform')">
                ...
                <flux:navlist.item icon="calendar" :href="route('fairs.index')"
                    :current="request()->routeIs('fairs.*')" wire:navigate>
                    Feirinhas
                </flux:navlist.item>
