...
<body
    class="min-h-screen antialiased bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-gray-900 dark:text-white">
    <div class="flex h-screen overflow-hidden">
        <div class="hidden lg:flex lg:flex-col lg:w-64 lg:fixed lg:inset-y-0">
            <div
                class="flex flex-col flex-grow bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm border-r border-white/20 dark:border-gray-700/50 shadow-xl overflow-y-auto">
                <!-- Logo Section -->
                <div
                    class="flex items-center flex-shrink-0 px-6 py-6 border-b border-gray-200/50 dark:border-gray-700/50">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-3 group" wire:navigate>
                        <div
                            class="p-2 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl shadow-lg group-hover:shadow-xl transition-all duration-200 group-hover:scale-110">
                ...
                <nav class="flex-1 px-4 py-6 space-y-2">
                    <a href="{{ route('dashboard') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="p-1.5 rounded-lg {{ request()->routeIs('dashboard') ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 group-hover:bg-gradient-to-r group-hover:from-blue-500 group-hover:to-purple-600 group-hover:text-white' }} transition-all duration-200">
                    ...
                    <a href="{{ route('fairs.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="p-1.5 rounded-lg {{ request()->routeIs('fairs.*') ? 'bg-gradient-to-r from-orange-500 to-red-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 group-hover:bg-gradient-to-r group-hover:from-orange-500 group-hover:to-red-600 group-hover:text-white' }} transition-all duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="{{ route('pos') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="p-1.5 rounded-lg {{ request()->routeIs('pos') ? 'bg-gradient-to-r from-purple-500 to-pink-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 group-hover:bg-gradient-to-r group-hover:from-purple-500 group-hover:to-pink-600 group-hover:text-white' }} transition-all duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                    ...
                    <a href="{{ route('customers.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="p-1.5 rounded-lg {{ request()->routeIs('customers.*') ? 'bg-gradient-to-r from-indigo-500 to-blue-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 group-hover:bg-gradient-to-r group-hover:from-indigo-500 group-hover:to-blue-600 group-hover:text-white' }} transition-all duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <a href="{{ route('users.index') }}"
                        ...
                        <div class="flex items-center gap-3">
                            <div
                                class="p-1.5 rounded-lg {{ request()->routeIs('users.*') ? 'bg-gradient-to-r from-teal-500 to-cyan-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400 group-hover:bg-gradient-to-r group-hover:from-teal-500 group-hover:to-cyan-600 group-hover:text-white' }} transition-all duration-200">
                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                    <path
                ...
                <!-- Bottom Section -->
                <div
                    class="flex-shrink-0 p-4 border-t border-gray-200/50 dark:border-gray-700/50 bg-gradient-to-r from-gray-50/50 to-gray-100/50 dark:from-gray-800/50 dark:to-gray-900/50">
        ...
        <div id="mobile-menu-overlay" class="fixed inset-0 z-40 lg:hidden hidden">
            ...
            <div
                class="fixed inset-y-0 left-0 w-64 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-r border-white/20 dark:border-gray-700/50 shadow-2xl">
                <div class="flex flex-col h-full">
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between mb-4">
                            ...
                            <button onclick="toggleDarkMode()"
                                class="p-2 rounded-xl bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 hover:shadow-lg transition-all duration-200 transform hover:scale-110">
                                <svg id="sun-icon-mobile" class="h-5 w-5 hidden" fill="none"
